...
checkpoint_PATH= './checkpoint/roberta-base_20ng/checkpoint1.pth'
Checkpoint = th.load(checkpoint_PATH)
# model_dict = model.state_dict()
# # model_dict.update(Checkpoint)
# # model.load_state_dict(model_dict)
model.load_state_dict(Checkpoint['bert_model'], strict=False)
model.load_state_dict(Checkpoint['bert_model'], strict=False)
model.load_state_dict(Checkpoint['classifier'], strict=False)
model.load_state_dict(Checkpoint['gcn'], strict=False)
